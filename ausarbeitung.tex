...
Ein Ausführungsmodell beschreibt, wie ein Programm aus einer Quellsprache transformiert werden muss, um es in eine ausführbare Form zu bringen und wie der Prozess des Ausführens abläuft.
Der Genaue Ablauf des Transformierens und des Ausführens kann sich dabei stark zwischen einzelnen Quellsprachen unterscheiden.
Teilweise können mehrere Schritte nötig sein, um eine Quellsprache in eine ausführbare Form zu bringen und auch beim Ausführen selbst kann es Optimierungen geben, die für eine Sprache spezifisch sind.
...
%%% mode: latex
%%% TeX-master: t
%%% reftex-default-bibliography: ("./bib/bibtex.bib")
%%% End:
