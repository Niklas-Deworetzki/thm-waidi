...
\author{Niklas Deworetzki \and THM\thanks{FB MNI Mathematik, Naturwissenschaften, Informatik}}
...
Es muss jedoch die Signatur für die Funktion angegeben werden, um den Typen auf \texttt{Int} zu beschränken, da sonst per Typinferenz der unbegrenzte Ganzzahlentyp \texttt{Integer} gewählt wird.
...
Wie zu sehen ist, benötigt der interpretierte Python-Code die meiste Rechenzeit.
Schneller als der Python-Code ist der kompilierte Maschinencode von Haskell, welcher dennoch etwas langsamer ist, als der Bytecode der auf der JVM ausgeführt wird. Zudem wird deutlich, dass die Rechenzeiten als Exponentialfunktion dargestellt werden können, was der theoretischen Laufzeitkomplexität des Algorithmus entspricht.
...
Die Rechenzeit des Java-Codes wirkt nahezu konstant mit leichten Schwankungen um einen konstanten Wert.
